        ...
        for (var property in values) {
            ...
            if (item.status != false) {
               ...
               if (date1.getTime() - item.date > avg_lasted) {
                    ...
                    item.message = "Lasts on average " + Math.round(((avg_lasted) / (60*60*24*1000)))  + " day(s). Last added " + Math.round(((date1.getTime() - item.date) / (60*60*24*1000))) + " day(s) ago"
                    ...
                    if(avg_added <= date1.getTime() - item.added[item.added.length-1]){
                        item.message = "Added on average every " +Math.round(((avg_added) / (60*60*24*1000)))  + " day(s). Last added "+ Math.round(((date1.getTime() - item.added[item.added.length-1]) / (60*60*24*1000))) + " day(s) ago"
                        soonOutOfStock.push(item)
                    }
