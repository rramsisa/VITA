...
import 'dart:io';
  ...
  Future<bool> loginCall(String email, String pass) async{
    var call;
    if(Platform.isAndroid){
      call = "http://10.0.2.2:3000/api/user/login/"; //base route for the api calls
    }
    else{
  ...
  Future<bool> signUpCall(String name, String email, String pass, BuildContext context) async{
    var call;
    if(Platform.isAndroid){
      call = "http://10.0.2.2:3000/api/user/register/"; //base route for the api calls
    }
    else{
  ...
  Future<bool> changePassCall(String pass, String newPass, String email, BuildContext context) async{
    var call;
    if(Platform.isAndroid){
      call = "http://10.0.2.2:3000/api/user/changePassword/"; //base route for the api calls
    }
    else{
